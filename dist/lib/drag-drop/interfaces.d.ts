...
import { ActionRendererProps, ColumnHeader, HeaderRendererProps, RowRendererProps } from '../interfaces';
/**
 ...
 */
export interface DragDropRowRendererProps<CellType extends RDS.Cell<CellType, V>, V = string, ARP extends ActionRendererProps<CellType, V> = ActionRendererProps<CellType, V>> extends RowRendererProps<CellType, V, ARP>, DragDropRowProps<CellType, V> {
}
/**
 * Extends `HeaderRendererProps` to include drag and drop properties.
 */
export interface DragDropHeaderRendererProps<T extends ColumnHeader = ColumnHeader> extends HeaderRendererProps<T>, DragDropHeaderProps {
}
